...
class EntityRecognizer:
    ...
    def remove_duplicates(results: List[RecognizerResult]) -> List[RecognizerResult]:
        ...
        Remove duplicates in case the two results have overlapping positions.
        When multiple recognizers match the same text span, keep the one with
        the highest score.
